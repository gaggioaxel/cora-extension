...
def mount(cheshire_cat_api):
    ...
    cheshire_cat_api.mount("/admin", StaticFiles(directory="/home/gaggio/Documents/Extra/bot/admin"), name="admin")
...
def mount_admin_spa(cheshire_cat_api):
    ...
    def get_admin_single_page_app(
        ...
        return FileResponse("/home/gaggio/Documents/Extra/bot/admin/index.html")
